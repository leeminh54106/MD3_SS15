            ...
            <div class="col-12">
                <form action="/category-controller" class="sign__form sign__form--add" method="post">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="sign__group">
                                        <input type="text" class="sign__input" name="name" placeholder="Tên danh mục">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <button type="submit" value="add" name="action" class="sign__btn sign__btn--small"><span>Thêm danh mục</span></button>
                        </div>
                    </div>
                </form>
            </div>
