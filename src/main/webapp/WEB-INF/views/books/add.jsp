...
<main class="main">
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- form -->
            <div class="col-12">
                <form action="/book-controller" class="sign__form sign__form--add" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-12 col-xl-7">
                            <div class="row">
                                <div class="col-12">
                                    <div class="sign__group">
                                        <input type="text" class="sign__input" name="name" placeholder="Tên sách">
                                    </div>
                                </div>

                                <div class="col-12">
                                    <div class="sign__group">
                                        <input id="text" name="author" class="sign__input" placeholder="Nhà xuất bản">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <div class="sign__gallery">
                                            <label id="gallery1" for="image">Upload cover (240x340)</label>
                                            <input data-name="#gallery1" id="image" name="image" class="sign__gallery-upload" type="file" accept=".png, .jpg, .jpeg" multiple="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-xl-5">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <input type="number" name="price" class="sign__input" placeholder="Giá sách">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <input type="number" name="totalPages" class="sign__input" placeholder="Số trang">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <input type="number" name="stock" class="sign__input" placeholder="Số lượng">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <input type="number" class="sign__input" name="yearCreated" placeholder="Năm phát hành">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="sign__group">
                                        <select class="sign__input" name="categoryId" id="categoryId">
                        ...
                        <div class="col-12">
                            <button type="submit" value="add" name="action" class="sign__btn sign__btn--small"><span>Thêm sách</span></button>
                        </div>
                    </div>
                </form>
            </div>
