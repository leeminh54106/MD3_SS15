            ...
            <div class="col-12">
                <div class="main__title">
                    ...
                    <div class="main__title-wrap">
                        <a href="/book-controller?action=add" class="main__title-link main__title-link--wrap">Thêm sách</a>

                        <!-- search -->
                        <form action="/book-controller" method="post" class="main__title-form">
                            <input type="text" name="bookName" placeholder="Tìm kiếm sách">
                    ...
                    <table class="catalog__table">
                        ...
                        <tbody>
                            <c:forEach items = "${books}" var = "b">
                                <tr>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;" >${b.id}</div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;" >${b.name}</div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;" >
                                                ${b.categoryId}
                                        </div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;" >
                                            <img src="${b.image}" alt="" style="width: 60px; height: 60px; object-fit: cover; border-radius: 3px">
                                        </div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;" >${b.price}</div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;" >${b.stock}</div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;" >${b.totalPages}</div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;">${b.yearCreated}</div>
                                    </td>
                                    <td >
                                        <div class="catalog__text" style="text-align: center; width: 100%; display: block;">${b.author}</div>
                                    </td>
                                    <td >
                                        <div class="catalog__text ${b.status ? 'catalog__text--green' : 'catalog__text--red'}" style="text-align: center; width: 100%; display: block;" >
                                                ${b.status ? "Bán" : "Không bán"}
                                        </div>
                                    </td>
                                    <td style="text-align: center">
                                        <div class="catalog__btns">
                                            <a href="/book-controller?action=detail&id=${b.id}" class="catalog__btn catalog__btn--view">
                                                <i class="ti ti-eye"></i>
                                            </a>
                                            <a href="/book-controller?action=edit&id=${b.id}" class="catalog__btn catalog__btn--edit">
                                                <i class="ti ti-edit"></i>
                                            </a>
                                            <a href="/book-controller?action=delete&id=${b.id}" class="catalog__btn catalog__btn--delete" data-bs-target="#modal-delete">
